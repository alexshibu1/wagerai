        ...
        <div className="space-y-6 mt-6">
          ...
          <div>
            ...
            <Input
              ...
              className="bg-white/[0.03] border border-white/[0.08] rounded-lg px-4 h-12 text-white text-lg font-medium focus-visible:ring-1 focus-visible:ring-neon-mint focus-visible:border-neon-mint transition-all"
            />
          </div>
          ...
          {showLinkOption && (
            <div>
              ...
              <Select value={linkedYearWagerId} onValueChange={setLinkedYearWagerId}>
                <SelectTrigger className="glass-panel h-12 text-white border-white/[0.08] focus:ring-1 focus:ring-neon-mint">
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="data-text text-4xl font-bold neon-mint">
            ...
            <Slider
              ...
              max={5000}
              step={100}
              className="w-full [&_[role=slider]]:bg-neon-mint [&_[role=slider]]:border-neon-mint [&_[role=slider]]:shadow-[0_0_12px_rgba(0,255,148,0.6)] [&_[role=slider]]:w-5 [&_[role=slider]]:h-5"
            />
          ...
          <Button
            ...
            disabled={!title.trim()}
            className="w-full bg-gradient-to-r from-neon-mint to-[#00D97E] hover:from-neon-mint/90 hover:to-[#00D97E]/90 text-black font-bold uppercase tracking-[0.25em] text-sm h-14 disabled:opacity-50 disabled:cursor-not-allowed shadow-[0_0_20px_rgba(0,255,148,0.3)] transition-all"
          >
            EXECUTE ORDER
          </Button>
        </div>
